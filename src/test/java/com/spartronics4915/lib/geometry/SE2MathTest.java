...
public class SE2MathTest
{
    ...
    {
        // Test constructors
        //System.out.println("{testRotation2 begin-----------------");
        Rotation2 rot1 = new Rotation2();
        ...
        rot1 = Rotation2.fromRadians(Math.PI / 2);
        ...
        rot1 = Rotation2.fromDegrees(270);
        assertEquals(0, rot1.cos(), kTestEpsilon);
        assertEquals(-1, rot1.sin(), kTestEpsilon);
        assertTrue(-1 / kTestEpsilon > rot1.tan());
        assertEquals(-90, rot1.getDegrees(), kTestEpsilon);
        ...
        // Test rotateBy
        rot1 = Rotation2.fromDegrees(45);
        rot2 = Rotation2.fromDegrees(45);
        Rotation2 rot3 = rot1.rotateBy(rot2);
        ...
        Rotation2 identity = new Rotation2();
        rot1 = Rotation2.fromDegrees(21.45);
        ...
        // Test interpolation
        rot1 = Rotation2.fromDegrees(45);
        rot2 = Rotation2.fromDegrees(135);
        ...
        rot2 = Rotation2.fromDegrees(-135);
        assertTrue(rot1.isParallel(rot2));
        // System.out.println("testRotation2 end------------------}");
    }
    ...
    public void testTranslation2()
    {
        ...
        // Test rotateBy
        pos1 = new Translation2(2, 0);
        Rotation2 rot1 = Rotation2.fromDegrees(90);
        ...
        // Test translateBy
        pos1 = new Translation2(2, 0);
        pos2 = new Translation2(-2, 1);
        Translation2 pos3 = pos1.translateBy(pos2);
        ...
        Translation2 identity = new Translation2();
        pos1 = new Translation2(2.16612, -23.55);
        ...
        // Test interpolation
        pos1 = new Translation2(0, 1);
        pos2 = new Translation2(10, -1);
        ...
        // System.out.println("testTranslation2 end------------------}");
    }
    ...
    public void testPose2()
    {
        ...
        pose1 = new Pose2(new Translation2(3, 4), Rotation2.fromDegrees(45));
        ...
        // Test transformation
        pose1 = new Pose2(new Translation2(3, 4), Rotation2.fromDegrees(90));
        Pose2 pose2 = new Pose2(new Translation2(1, 0), Rotation2.fromDegrees(0));
        Pose2 pose3 = pose1.transformBy(pose2);
        ...
        pose1 = new Pose2(new Translation2(3, 4), Rotation2.fromDegrees(90));
        pose2 = new Pose2(new Translation2(1, 0), Rotation2.fromDegrees(-90));
        ...
        pose1 = new Pose2(new Translation2(3.51512152, 4.23), Rotation2.fromDegrees(91.6));
        ...
        pose1 = new Pose2(new Translation2(3, 4), Rotation2.fromDegrees(90));
        pose2 = new Pose2(new Translation2(13, -6), Rotation2.fromDegrees(0.0));
    ...
    {
        // Exponentiation (integrate twist to obtain a Pose2)
        // System.out.println("{ testTwist begin------------------");
        Twist2 twist = new Twist2(1.0, 0.0, 0.0);
        Pose2 pose = Pose2.exp(twist);
        ...
        // Scaled.
        twist = new Twist2(1.0, 0.0, 0.0);
        pose = Pose2.exp(twist.scaled(2.5));
        assertEquals(2.5, pose.getTranslation().x(), kTestEpsilon);
        assertEquals(0.0, pose.getTranslation().y(), kTestEpsilon);
        assertEquals(0.0, pose.getRotation().getDegrees(), kTestEpsilon);

        // Logarithm (find the twist to apply to obtain a given Pose2)
        pose = new Pose2(new Translation2(2.0, 2.0), Rotation2.fromRadians(Math.PI / 2));
        twist = Pose2.log(pose);
        ...
        Pose2 new_pose = Pose2.exp(twist);
